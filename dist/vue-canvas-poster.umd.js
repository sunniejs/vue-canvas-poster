(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["vue-canvas-poster"] = factory();
	else
		root["vue-canvas-poster"] = factory();
...
"use strict";
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_6_oneOf_1_0_node_modules_css_loader_index_js_ref_6_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_6_oneOf_1_3_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_canvas_poster_vue_vue_type_style_index_0_id_16c8b4b4_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("feeb");
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_6_oneOf_1_0_node_modules_css_loader_index_js_ref_6_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_6_oneOf_1_3_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_canvas_poster_vue_vue_type_style_index_0_id_16c8b4b4_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_6_oneOf_1_0_node_modules_css_loader_index_js_ref_6_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_6_oneOf_1_3_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_canvas_poster_vue_vue_type_style_index_0_id_16c8b4b4_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__);
/* unused harmony reexport * */
 /* unused harmony default export */ var _unused_webpack_default_export = (_node_modules_vue_style_loader_index_js_ref_6_oneOf_1_0_node_modules_css_loader_index_js_ref_6_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_6_oneOf_1_3_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_canvas_poster_vue_vue_type_style_index_0_id_16c8b4b4_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0___default.a); 
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"35b68e96-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/lib/canvas-poster.vue?vue&type=template&id=16c8b4b4&scoped=true&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_c('canvas',{ref:"canvas",staticClass:"canvas",style:(_vm.painterStyle)})])}
var staticRenderFns = []


// CONCATENATED MODULE: ./src/lib/canvas-poster.vue?vue&type=template&id=16c8b4b4&scoped=true&
...
var GD = __webpack_require__("1a26");
  ...
  _createClass(Painter, [{
    ...
    value: function _drawAbsImage(view) {
      ...
      var _this$_preProcess3 = this._preProcess(view),
          ...
          height = _this$_preProcess3.height; // 获得缩放到图片大小级别的裁减框
...
var util_equal = function equal(a, b) {
  if (a === b) return true;
...
/* harmony default export */ var canvas_postervue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    isNeedRefresh: function isNeedRefresh(newVal, oldVal) {
      if (!newVal || this.isEmpty(newVal) || this.dirty && util_equal(newVal, oldVal)) {
        return false;
      }
    ...
    startPaint: function startPaint() {
      ...
      this.downloadImages().then(function (res) {
        var width = res.width,
            height = res.height;
        ...
        if (_this2.widthPixels) {
          // 重设宽度，高度
          setStringPrototype(_this2.widthPixels / _this2.canvasWidthInPx);
          _this2.canvasWidthInPx = _this2.widthPixels;
        }

        _this2.canvasHeightInPx = height.toPx();
        _this2.painterStyle = "width:".concat(_this2.canvasWidthInPx, "px;height:").concat(_this2.canvasHeightInPx, "px;");
        _this2.canvas = _this2.$refs.canvas; // 指定canvas

        _this2.canvas.width = _this2.canvasWidthInPx;
        _this2.canvas.height = _this2.canvasHeightInPx;

        var ctx = _this2.canvas.getContext("2d"); //设置2D渲染区域


        var pen = new painter_Painter(ctx, res);
        pen.paint(function () {
          var imageBase64 = _this2.canvas.toDataURL("image/png");

          _this2.$emit('success', imageBase64);
        });
      }).catch(function (err) {
    ...
    downloadImages: function downloadImages() {
      ...
      return new Promise(function (resolve, reject) {
        var preCount = 0;
        var completeCount = 0;
        var paintCopy = JSON.parse(JSON.stringify(_this3.painting));

        if (paintCopy.background) {
          preCount++;

          _this3.download(paintCopy.background).then(function (image) {
          ...
          try {
            var _loop = function _loop() {
              ...
              if (view && view.type === 'image' && view.url) {
                ...
                _this3.download(view.url).then(function (image) {
                  completeCount++;
            ...
            for (var _iterator = paintCopy.views[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
              _loop();
            }
          } catch (err) {
            _didIteratorError = true;
...
// EXTERNAL MODULE: ./src/lib/canvas-poster.vue?vue&type=style&index=0&id=16c8b4b4&scoped=true&lang=css&
var canvas_postervue_type_style_index_0_id_16c8b4b4_scoped_true_lang_css_ = __webpack_require__("6d1d");
...
// module
exports.push([module.i, ".canvas[data-v-16c8b4b4]{position:fixed;top:2000px}", ""]);
...
// load the styles
var content = __webpack_require__("a733");
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var add = __webpack_require__("499e").default
var update = add("1a81eb9a", content, true, {"sourceMap":false,"shadowMode":false});

/***/ })

/******/ });
});
//# sourceMappingURL=vue-canvas-poster.umd.js.map